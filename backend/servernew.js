...
const { getAllUsers, getUserById, createUser,deleteUser,registNewuser,getCssFile, getJSFile} = require('../backend/controller/userController')
...
const server = http.createServer((req ,res)=>{
  ...
  else if (req.method.toLowerCase() ==='delete' && req.url.match(/\/user\/employee\/([a-z0-9\-]+)/)){
    const id =   req.url.split('/')[3]
